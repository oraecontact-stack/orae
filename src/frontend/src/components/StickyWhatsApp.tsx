...
export function StickyWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-50 flex items-center gap-2 bg-primary text-primary-foreground px-4 py-3 rounded-full shadow-lg transition-smooth hover:opacity-90 active:scale-95 sm:bottom-8"
